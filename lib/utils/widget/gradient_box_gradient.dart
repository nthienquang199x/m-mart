...
///
/// The [GradientShadowBoxDecoration] class provides a variety of ways to draw a box.
///
...
/// {@tool snippet}
///
/// The following applies a [GradientShadowBoxDecoration] to a [Container] widget to draw an
...
class GradientShadowBoxDecoration extends Decoration {
  ...
  const GradientShadowBoxDecoration({
  ...
  /// new values.
  GradientShadowBoxDecoration copyWith({
    Color? color,
  ...
  ///
  /// The [shape] cannot be interpolated; animating between two [GradientShadowBoxDecoration]s
  ...
  GradientShadowBoxDecoration scale(double factor) {
    return GradientShadowBoxDecoration(
  ...
  static GradientShadowBoxDecoration? lerp(GradientShadowBoxDecoration? a, GradientShadowBoxDecoration? b, double t) {
  ...
  bool operator ==(Object other) {
    ...
    return other is GradientShadowBoxDecoration &&
        other.color == color &&
        other.image == image &&
        other.border == border &&
...
class _BoxDecorationPainter extends BoxPainter {
  ...
  final GradientShadowBoxDecoration _decoration;
  ...
  void _paintShadows(Canvas canvas, Rect rect, TextDirection? textDirection) {
    if (_decoration.boxShadow == null) {
      const boxShadow = BoxShadow(blurRadius: 15, spreadRadius: 2, color: Colors.black);
  ...
  void _drawShadow(BoxShadow boxShadow, Canvas canvas, Rect rect, TextDirection? textDirection) {
